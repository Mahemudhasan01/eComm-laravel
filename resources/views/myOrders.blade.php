                        ...
                        <div class="col-sm-10">
                            <div class="col-sm-7">
                                <a href=" {{ route('product.detail', ['id' => $item->product_id]) }} ">
                                    ...
                                    <a href="{{ route('product.order.cancel', ['id' => $item->product_id]) }}"><button class="btn btn-danger">Cancel Order</button></a>
                                    <a href="{{ route('product.status', ['id' => $item->product_id]) }}"><button class="btn btn-success"> Check Status</button></a>
                                </a>
                            </div>
                        </div>
                    </div>
